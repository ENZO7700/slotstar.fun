...
export function Header() {
  ...
  return (
    <header className="sticky top-0 right-0 left-0 lg:left-[240px] h-16 bg-zinc-950/80 backdrop-blur-md border-b border-zinc-900 flex items-center justify-between px-6 z-20">
